...
<div>
    ...
    <ul class="nav justify-content-center">
        <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="{{ route('admin.event.index') }}">UPCOMING TOURNAMENTS</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{ route('admin.event.indexPast') }}">PAST TOURNAMENTS</a>
        </li>
    </ul>

    <div class="container" style="--bs-columns: 3;">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="flex">
                            ...
                            <p class="card-text"><small>{{ $event->is_active == 1 ? "Active" : "No Active" }}</small></p>
                        </div>
                        <div class="flex">
